...
EXTRACTION_SYSTEM_PROMPT_TEMPLATE_V2 = (
    ...
    "3. First inspect hashtags before choosing descriptive category phrases. "
    "If a hashtag is near an address, hours, menu list, phone number, or place "
    "marker, it may be the store name; prioritize it when it appears on the same "
    "line as a map-pin. Prefer specific proper-noun hashtags, but do not use "
    "generic hashtags. If store_name is taken from a hashtag, remove the leading #. "
