...
def test_instagram_tv_url_is_supported_as_tv_media() -> None:
    url = "https://www.instagram.com/tv/DVDm96wjwWC/?igsh=abc"

    assert is_instagram_media_url(url)
    assert instagram_media_type(url) == "tv"
    assert canonical_instagram_media_url(url) == "https://www.instagram.com/tv/DVDm96wjwWC/"
